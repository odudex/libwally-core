...
class PSBTTests(unittest.TestCase):
    ...
    def test_musig2_psbt_populate_from_descriptor(self):
        ...
        inp1 = psbt.contents.inputs[1]
        out1 = psbt.contents.outputs[1]
        self.assertEqual(inp1.musig2_pubkeys.num_items, 0)
        self.assertEqual(inp1.taproot_leaf_paths.num_items, 0)
        ...
        self.assertEqual(out1.musig2_pubkeys.num_items, 0)
