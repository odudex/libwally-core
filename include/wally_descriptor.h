...
#define WALLY_MS_IS_TAPSCRIPT     0x1000 /** Contains expressions in tapscript (tr() tree) context */
 ...
 * :param flags: For future use. Must be 0.
 * :param bytes_out: Destination for the compiled tapscript, or NULL to query size.
...
/**
 * Get the length of a script for a specific taptree leaf.
 *
...
/**
 * Get the length of the control block for a specific taptree leaf.
 *
