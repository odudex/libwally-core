...
function(generate_config_file)
    ...
    if(WALLYCORE_ENABLE_MBED_TLS AND WALLYCORE_ENABLE_PSA_CRYPTO)
        message(FATAL_ERROR "WALLYCORE_ENABLE_MBED_TLS and WALLYCORE_ENABLE_PSA_CRYPTO are mutually exclusive")
    endif()
    if(WALLYCORE_ENABLE_PSA_CRYPTO)
        check_include_file("psa/crypto.h" HAVE_PSA_CRYPTO_H)
        if(NOT HAVE_PSA_CRYPTO_H)
            message(FATAL_ERROR "psa/crypto.h not found")
        endif()
    endif()
