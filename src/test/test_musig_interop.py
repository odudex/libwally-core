...
class Bip373FieldEncodingTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.agg_pubkey_buf, _ = make_cbuffer('00' * EC_PUBLIC_KEY_LEN)
        assert wally_musig_pubkey_get(self.cache, self.agg_pubkey_buf,
                                      EC_PUBLIC_KEY_LEN) == WALLY_OK
        self.agg_pubkey = bytes(self.agg_pubkey_buf)
    ...
    def test_nonce_round_trip(self):
        ...
        # Verify nonce count
        ret, count = wally_psbt_input_get_musig2_pubnonce_size(self.psbt.contents.inputs[0])
        ...
        ret, count2 = wally_psbt_input_get_musig2_pubnonce_size(psbt2.contents.inputs[0])
