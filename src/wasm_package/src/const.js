...
export const WALLY_MS_IS_MUSIG = 0x2000; /** A musig() key aggregate (BIP-390) */
export const WALLY_MS_IS_PARENTED = 0x0080; /** Contains at least one key key with a parent key origin */
...
export const WALLY_MS_IS_TAPSCRIPT = 0x1000; /** Contains expressions in tapscript (tr() tree) context */
